            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="<?php if ($identity->avatar) {echo $identity->avatar;} else {echo Yii::$app->getRequest()->getBaseUrl() . '/static/img/profile_small.jpg';} ?>" /></span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold"><?= $identity->username; ?></strong></span>
                                <span class="text-muted text-xs block"><?= $identity->getRolesNameString()?><b class="caret"></b></span>
                                </span>
                        </a>
